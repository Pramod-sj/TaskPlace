package com.expertprogramming.taskplace.Database;
...
public class FirebaseDatabaseHelper {
    ...
    public void moveDataToHistoryChild(final String taskid){
        taskDetailsCloudEndPoint.child(currentUserData.getCurrentUID()).child(taskid).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
