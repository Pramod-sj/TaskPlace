...
import static com.expertprogramming.taskplace.R.layout.activity_maps;
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                try {
                    ...
                    if(addresses.size()>0) {
                        ...
                        Toasty.warning(getActivity().getApplicationContext(),"Please select a valid place",Toast.LENGTH_SHORT).show();
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
