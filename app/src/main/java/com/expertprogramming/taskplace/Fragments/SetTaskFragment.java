...
import com.expertprogramming.taskplace.Database.FirebaseDatabaseHelper;
    ...
    public void onStart(){
        ...
        if(b!=null){
            ...
            if(placeSelected!=null) {
                ...
                Snackbar snackbar=Snackbar.make(getActivity().findViewById(R.id.ll1),"No Saved place",Snackbar.LENGTH_LONG)
