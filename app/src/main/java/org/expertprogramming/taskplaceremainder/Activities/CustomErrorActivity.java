...
public class CustomErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(org.expertprogramming.taskplaceremainder.R.layout.activity_customeerror);
        log=CustomActivityOnCrash.getStackTraceFromIntent(getIntent());
        Button restartButton = findViewById(org.expertprogramming.taskplaceremainder.R.id.restart_button);
        ...
        if (config.isShowRestartButton() && config.getRestartActivityClass() != null) {
            restartButton.setText(org.expertprogramming.taskplaceremainder.R.string.restart_app);
        ...
        Button send=findViewById(org.expertprogramming.taskplaceremainder.R.id.Send_button);
