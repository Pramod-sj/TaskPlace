...
import org.expertprogramming.taskplaceremainder.Activities.MainActivity;
import org.expertprogramming.taskplaceremainder.Activities.ScrollingActivity;
import org.expertprogramming.taskplaceremainder.BroadCastReceiver.AlarmBroadCastReceiver;
...
public class NotificationHelper {
    ...
    public Notification showServiceNotification(String place, Float distance){
        String body="";
        if(place!=null && distance!=null) {
            body=String.valueOf(distance.intValue())+" m away from "+place;
        }
        NotificationChannel channel;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
